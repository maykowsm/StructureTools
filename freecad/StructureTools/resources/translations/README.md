# About translating StructureTools Workbench

> [!NOTE]
> All commands **must** be run in `./freecad/StructureTools/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **StructureTools** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **StructureTools** translatable strings execute
...
Also you can rename new `StructureTools.ts` file by appending the locale code,
...
once done, look for the **StructureTools** project.
...
Now you can contribute your translated `.ts` file to **StructureTools** repository,
also include the `.qm` file.

<https://www.patreon.com/c/StructureTools>
